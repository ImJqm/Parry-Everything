 ...
 */
@Mod.EventBusSubscriber(modid = ParryEverything.MODID, bus = Mod.EventBusSubscriber.Bus.FORGE, value = Dist.CLIENT)
public class ParryAnimationTrigger {
    ...
    public static void onChatReceived(ClientChatReceivedEvent event) {
        ...
        if (event.getMessage().contains(Component.literal("waving"))) {
            ...
            var animation = (ModifierLayer<IAnimation>)PlayerAnimationAccess.getPlayerAssociatedData((AbstractClientPlayer) player).get(new ResourceLocation(ParryEverything.MODID, "animation"));
            if (animation != null) {
